...
const mainItems = [
  ...
  { title: "Rendimiento", url: "/performance", icon: BarChart3 },
  { title: "Simulador", url: "/simulator", icon: Activity },
  { title: "Log Detallado", url: "/detailed-history", icon: Database },
    ...
    <Sidebar collapsible="icon" className="border-r border-sidebar-border">
      <SidebarContent>
        <div className="p-4 flex items-center gap-2">
          ...
          {!collapsed && (
            <span className="text-lg font-bold gradient-text whitespace-nowrap">BetBot AI</span>
          )}
        </div>
